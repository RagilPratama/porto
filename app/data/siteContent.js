export const en = {
  ...
  portfolio: {
    items: [
      { title: 'Ocean by BCA', description: 'An integrated business ecosystem platform connecting 34+ million customers with banking, operational, and industry networks. Features include integrated dashboard for cash flow monitoring, product recommendations, and myEcosystem for business collaboration.', info: 'BCA — Business Platform' },
      { title: 'AIA Insurance Web App', description: 'A comprehensive and responsive insurance portal developed using Vue.js 3, Pinia, and Vue Router, designed to streamline policy management and enhance user experience for AIA customers.', info: 'AIA Indonesia — Internal' },
      { title: 'OASE — BCA', description: 'A high-availability internal banking API system for Bank Central Asia (BCA), built with Node.js and Express. It serves as a critical middleware layer for processing secure transactions and managing sensitive financial data with enterprise-grade security.', info: 'BCA — Internal' },
      { title: 'SIDARA & SUPEL', description: 'Internal management systems for the Ministry of Energy and Mineral Resources (ESDM), designed to streamline data reporting and administrative workflows using CodeIgniter and Laravel.', info: 'Kementerian ESDM — Internal' },
      { title: 'Minerba Homepage', description: 'The official public portal for the Directorate General of Mineral and Coal, providing real-time information and regulations built with PHP frameworks including Yii and Laravel.', info: 'Kementerian ESDM — Public Portal' },
      { title: 'BKKBN Portal & Siga App', description: 'A large-scale national family information system (SIGA) that facilitates data collection and demographic analysis across Indonesia, featuring a robust API ecosystem built with Laravel and ReactJS.', info: 'BKKBN Indonesia — Government Project' },
      { title: 'WowPremi', description: 'An all-in-one digital insurance platform integrated with Midtrans for seamless payment processing. Available on Web, Android, and iOS to provide users with instant insurance quotes and easy policy issuance.', info: '' },
      { title: 'BKKBN API Ecosystem', description: 'Enterprise-grade RESTful API infrastructure that serves as a centralized data hub, securely connecting and synchronizing multiple internal government applications to ensure data integrity.', info: 'BKKBN Indonesia — Government Project' },
      { title: 'AIA+', description: 'A cutting-edge real-time digital insurance ecosystem that connects policyholders directly with service providers, offering instant access to health benefits, claims status, and personalized wellness tracking.', info: 'AIA Indonesia — Customer Facing' },
      { title: 'OGYA HRIS System', description: 'A comprehensive Human Resource Information System (HRIS) designed to automate human capital management, featuring employee data administration, attendance tracking, and streamlined HR workflows.', info: '' },
      { title: 'OGYA Company Profile', description: 'A high-performance corporate website designed to showcase OGYA\'s business services and corporate culture, featuring an integrated career portal for talent acquisition.', info: '' },
      { title: 'SmartCloud Indonesia', description: 'Advanced Quality Assurance and automated testing framework implemented for cloud-based enterprise solutions, ensuring high availability, security, and performance for mission-critical business systems.', info: '' },
      { title: 'Carfix', description: 'Advanced Quality Assurance and performance monitoring for a sophisticated automotive e-commerce ecosystem, ensuring seamless service integration and reliable booking for automotive services.', info: '' },
      { title: 'Sheldon Dental Management', description: 'An end-to-end clinical management solution for dental professionals, integrating patient scheduling, digital medical records, and inventory tracking to improve operational efficiency.', info: '' },
      { title: 'Pins Indonesia', description: 'A sleek and interactive frontend interface for Telkom Group\'s internal services, focusing on user-centric design and high-performance data visualization.', info: 'Pins Indonesia — Telkom Group' }
    ]
  }
};
...
export const id = {
    ...
    items: [
      {
        ...
        period: 'Lulus: 2025',
        highlight: 'Jakarta, Indonesia',
        description: 'Berfokus pada praktik rekayasa perangkat lunak, arsitektur web, dan pengembangan fullstack terapan.'
      },
      {
        ...
        period: 'Lulus: 2018',
        highlight: 'Bogor, Indonesia',
        description: 'Membangun fondasi kuat dalam pemrograman, quality assurance, dan kolaborasi proyek.'
      }
    ]
  },
  terminal: {
  ...
  experience: {
    items: [
      {
        role: 'Frontend Developer',
        impact: 'Membangun Ocean by BCA, platform ekosistem bisnis terintegrasi yang menghubungkan 34+ juta pelanggan dengan layanan perbankan, operasional, dan jaringan industri.',
        points: [
      ...
      {
        role: 'Frontend Developer',
        impact: 'Menghadirkan arsitektur frontend yang dapat digunakan ulang dan UI berfokus performa untuk produk asuransi yang melayani jutaan pemegang polis.',
        points: [
      ...
      {
        role: 'Backend Developer',
        impact: 'Merancang layanan backend berperforma tinggi untuk infrastruktur perbankan internal yang menangani pemrosesan transaksi yang aman.',
        points: [
      ...
      {
        role: 'Fullstack Developer',
        impact: 'Menghadirkan platform layanan publik berskala nasional untuk program keluarga berencana dan kependudukan di seluruh Indonesia.',
        points: [
      ...
      {
        role: 'Fullstack Developer',
        impact: 'Memimpin pengembangan sistem manajemen internal dan portal publik untuk tata kelola mineral dan batu bara.',
        points: [
      ...
      {
        role: 'Fullstack Developer',
        impact: 'Mempercepat alur onboarding asuransi melalui integrasi payment gateway dan API multi-partner.',
        points: [
      ...
      {
        role: 'Quality Assurance',
        impact: 'Meningkatkan kepercayaan rilis dan stabilitas produk melalui disiplin pengujian terstruktur dan pelaporan defect yang sistematis.',
        points: [
  ...
  portfolio: {
    items: [
      { title: 'Ocean by BCA', description: 'Platform ekosistem bisnis terintegrasi yang menghubungkan 34+ juta pelanggan dengan jaringan perbankan, operasional, dan industri. Dilengkapi dashboard terpadu untuk monitoring arus kas, rekomendasi produk, dan myEcosystem untuk kolaborasi bisnis.', info: 'BCA — Platform Bisnis' },
      { title: 'AIA Insurance Web App', description: 'Portal asuransi komprehensif dan responsif yang dikembangkan menggunakan Vue.js 3, Pinia, dan Vue Router, dirancang untuk menyederhanakan manajemen polis dan meningkatkan pengalaman pengguna pelanggan AIA.', info: 'AIA Indonesia — Internal' },
      { title: 'OASE — BCA', description: 'Sistem API perbankan internal dengan ketersediaan tinggi untuk Bank Central Asia (BCA), dibangun dengan Node.js dan Express. Berfungsi sebagai lapisan middleware penting untuk memproses transaksi aman dan mengelola data keuangan sensitif dengan keamanan tingkat enterprise.', info: 'BCA — Internal' },
      { title: 'SIDARA & SUPEL', description: 'Sistem manajemen internal untuk Kementerian Energi dan Sumber Daya Mineral (ESDM), dirancang untuk memperlancar pelaporan data dan alur kerja administrasi menggunakan CodeIgniter dan Laravel.', info: 'Kementerian ESDM — Internal' },
      { title: 'Minerba Homepage', description: 'Portal publik resmi Direktorat Jenderal Mineral dan Batu Bara, menyediakan informasi dan regulasi real-time yang dibangun dengan framework PHP termasuk Yii dan Laravel.', info: 'Kementerian ESDM — Portal Publik' },
      { title: 'BKKBN Portal & Siga App', description: 'Sistem informasi keluarga berskala nasional (SIGA) yang memfasilitasi pengumpulan data dan analisis demografi di seluruh Indonesia, menampilkan ekosistem API yang kokoh dibangun dengan Laravel dan ReactJS.', info: 'BKKBN Indonesia — Proyek Pemerintah' },
      { title: 'WowPremi', description: 'Platform asuransi digital all-in-one yang terintegrasi dengan Midtrans untuk pemrosesan pembayaran yang mulus. Tersedia di Web, Android, dan iOS untuk memberikan kutipan asuransi instan dan penerbitan polis yang mudah.', info: '' },
      { title: 'BKKBN API Ecosystem', description: 'Infrastruktur RESTful API tingkat enterprise yang berfungsi sebagai pusat data terpadu, menghubungkan dan menyinkronkan beberapa aplikasi internal pemerintah dengan aman untuk memastikan integritas data.', info: 'BKKBN Indonesia — Proyek Pemerintah' },
      { title: 'AIA+', description: 'Ekosistem asuransi digital real-time yang menghubungkan pemegang polis langsung dengan penyedia layanan, menawarkan akses instan ke manfaat kesehatan, status klaim, dan pelacakan kebugaran yang dipersonalisasi.', info: 'AIA Indonesia — Berorientasi Pelanggan' },
      { title: 'OGYA HRIS System', description: 'Sistem Informasi Sumber Daya Manusia (HRIS) yang komprehensif dirancang untuk mengotomatisasi manajemen modal manusia, menampilkan administrasi data karyawan, pelacakan kehadiran, dan alur kerja HR yang efisien.', info: '' },
      { title: 'OGYA Company Profile', description: 'Situs web korporat berperforma tinggi yang dirancang untuk menampilkan layanan bisnis dan budaya perusahaan OGYA, dilengkapi portal karier terintegrasi untuk akuisisi talenta.', info: '' },
      { title: 'SmartCloud Indonesia', description: 'Kerangka pengujian Quality Assurance dan otomatisasi canggih yang diimplementasikan untuk solusi enterprise berbasis cloud, memastikan ketersediaan tinggi, keamanan, dan performa untuk sistem bisnis yang kritis.', info: '' },
      { title: 'Carfix', description: 'Quality Assurance canggih dan pemantauan performa untuk ekosistem e-commerce otomotif yang canggih, memastikan integrasi layanan yang mulus dan pemesanan yang andal untuk layanan otomotif.', info: '' },
      { title: 'Sheldon Dental Management', description: 'Solusi manajemen klinis end-to-end untuk profesional gigi, mengintegrasikan penjadwalan pasien, rekam medis digital, dan pelacakan inventaris untuk meningkatkan efisiensi operasional.', info: '' },
      { title: 'Pins Indonesia', description: 'Antarmuka frontend yang ramping dan interaktif untuk layanan internal Telkom Group, berfokus pada desain berpusat pengguna dan visualisasi data berperforma tinggi.', info: 'Pins Indonesia — Telkom Group' }
    ]
  }
};
