  ...
  <Transition name="welcome-screen">
    ...
    >
      ...
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          class="absolute inset-0 bg-gradient-to-r from-[#00629d]/20 to-[#00a3ff]/20 blur-2xl sm:blur-3xl animate-pulse"
        />
        <div
          class="absolute inset-0 bg-gradient-to-tr from-[#00629d]/10 via-transparent to-[#00a3ff]/10 blur-xl sm:blur-2xl animate-float"
        />
      </div>
      ...
      <div class="relative w-full mx-auto px-6 sm:px-8">
        ...
        <div class="welcome-cta text-center" style="animation-delay: 1200ms">
          ...
          >
            <div
              class="absolute inset-0 bg-gradient-to-r from-[#00629d]/20 to-[#00a3ff]/20 rounded-full blur-md group-hover:blur-lg transition-all duration-300"
            />
            <div
              class="relative flex items-center gap-2 text-sm sm:text-base md:text-lg lg:text-2xl font-body"
            >
              <svg
                class="w-4 h-4 sm:w-5 sm:h-5 text-[#00a3ff]"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                stroke-width="2"
              ...
              <span
                class="bg-gradient-to-r from-[#00629d] to-[#00a3ff] bg-clip-text text-transparent"
              >
      ...
      <div
        class="absolute inset-0 bg-[linear-gradient(to_right,#4f4f4f10_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f10_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none opacity-50"
      />
    </div>
  </Transition>
</template>
