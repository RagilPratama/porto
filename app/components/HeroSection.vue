    ...
    <div class="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
      <div class="lg:col-span-7 z-10 text-center lg:text-left">
        ...
        <div class="flex flex-wrap gap-4 justify-center lg:justify-start">
          ...
          <button @click="scrollTo('experience')" class="bg-white/40 dark:bg-slate-800/40 backdrop-blur-xl text-slate-800 dark:text-slate-200 border border-white/70 dark:border-white/10 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/70 dark:hover:bg-slate-800/70 hover:scale-[1.02] transition-all shadow-md">
            {{ t('hero.ctaSecondary') }}
          </button>
        </div>
      </div>
        ...
        <div class="relative w-full aspect-square flex items-center justify-center">
          ...
          <div class="absolute top-4 -right-4 glass-card px-4 py-3 rounded-2xl shadow-xl z-30 animate-float border border-white/80 dark:border-white/15">
            <div class="flex items-center gap-3">
              ...
              <span class="text-xs font-bold tracking-tight text-slate-800 dark:text-slate-200">{{ t('hero.frontendBadge') }}</span>
            </div>
          </div>
          ...
          <div class="absolute bottom-20 -left-8 glass-card px-4 py-3 rounded-2xl shadow-xl z-30 animate-float border border-white/80 dark:border-white/15" style="animation-delay: -2s;">
            <div class="flex items-center gap-3">
              ...
              <span class="text-xs font-bold tracking-tight text-slate-800 dark:text-slate-200">{{ t('hero.backendBadge') }}</span>
            </div>
          </div>
