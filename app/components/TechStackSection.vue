...
<template>
  <section class="py-24 overflow-hidden scroll-mt-40 relative" id="tech">
    ...
    <div class="max-w-7xl mx-auto px-8 relative z-10">
      ...
      <div class="space-y-6">
        <div data-animate="fade-right" data-delay="100" class="marquee marquee-mask overflow-hidden" role="region" :aria-label="t('tech.title')">
        ...
        <div data-animate="fade-left" data-delay="200" class="marquee marquee-mask overflow-hidden" role="region" :aria-label="t('tech.title')">
      ...
      <div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div data-animate="zoom-in" data-delay="0" class="glass-panel text-center p-8 rounded-3xl transition-all hover:scale-[1.02]">
        ...
        <div data-animate="zoom-in" data-delay="100" class="glass-panel text-center p-8 rounded-3xl transition-all hover:scale-[1.02]">
        ...
        <div data-animate="zoom-in" data-delay="200" class="glass-panel text-center p-8 rounded-3xl transition-all hover:scale-[1.02]">
