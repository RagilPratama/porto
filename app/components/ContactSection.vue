              ...
              >
                ...
                >
                  <path
                    ...
                    d="M16.5 6.75h-6A5.25 5.25 0 0 0 5.25 12v0A5.25 5.25 0 0 0 10.5 17.25h6a2.25 2.25 0 0 0 2.25-2.25V12A6.75 6.75 0 1 0 12 18.75"
                  />
                </svg>
              </div>
              <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-2 relative">
                ...
                <div class="relative">
                  <input
                    ...
                    :class="[
                      'w-full glass-input rounded-2xl p-4 pr-12 outline-none font-medium text-slate-900 dark:text-white',
                      errors.name ? 'border-red-400 ring-2 ring-red-400/20' : ''
                    ]"
                    required
                  />
                  <div
                    v-if="form.name.trim() && !errors.name"
                ...
                <p v-if="errors.name" class="text-xs text-red-500 ml-1 font-bold">
                  {{ errors.name }}
                </p>
              </div>
              ...
              <div class="space-y-2 relative">
                ...
                <div class="relative">
                  ...
                  />
                  <div
                    v-if="form.email.trim() && !errors.email"
                    class="absolute right-4 top-1/2 -translate-y-1/2 text-emerald-500"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <p v-if="errors.email" class="text-xs text-red-500 ml-1 font-bold">
                  {{ errors.email }}
                </p>
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <textarea
                  ...
                  :class="[
                    'w-full glass-input rounded-2xl p-4 pr-12 outline-none font-medium text-slate-900 dark:text-white',
                    errors.message ? 'border-red-400 ring-2 ring-red-400/20' : ''
                  ]"
                  required
                ></textarea>
                <div
                  v-if="form.message.trim() && !errors.message"
              ...
              <p v-if="errors.message" class="text-xs text-red-500 ml-1 font-bold">
                {{ errors.message }}
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  d="m8.5 12.5 2.25 2.25 4.75-4.75"
                />
              </svg>
            ...
            >
              ...
              <ul class="text-xs text-red-500 dark:text-red-400 font-medium list-disc ml-4">
                ...
                <li v-if="form.email.trim() && !/^\S+@\S+\.\S+$/.test(form.email)">
                  {{ t('contact.form.emailInvalidShort') }}
                </li>
