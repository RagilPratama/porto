...
.blueprint-bg::before {
  ...
  background:
    radial-gradient(
      800px circle at var(--mouse-x, 50%) var(--mouse-y, 30%),
    ...
    repeating-linear-gradient(
      90deg,
      rgba(0, 98, 157, 0.02) 0,
      rgba(0, 98, 157, 0.02) 1px,
      transparent 1px,
      transparent 24px
    );
  opacity: 0.7;
...
.section-texture-tech {
  background-image:
    ...
    repeating-linear-gradient(
      135deg,
      rgba(0, 98, 157, 0.06) 0,
      rgba(0, 98, 157, 0.06) 1px,
      transparent 1px,
      transparent 22px
    );
}
...
.section-texture-education {
  background-image:
    ...
    repeating-linear-gradient(
      135deg,
      rgba(0, 98, 157, 0.03) 0,
      rgba(0, 98, 157, 0.03) 1px,
      transparent 1px,
      transparent 26px
    );
}
...
.hero-seahorse-wave {
  ...
  inset: 0;
  background:
    radial-gradient(circle at 20% 20%, rgba(0, 163, 255, 0.5), transparent 24%),
...
.hero-seahorse-svg {
  ...
  background-image:
    radial-gradient(circle at 20% 18%, rgba(0, 163, 255, 0.22), transparent 28%),
    radial-gradient(circle at 72% 26%, rgba(0, 98, 157, 0.16), transparent 24%);
  filter: blur(0.6px);
  border-radius: 48% 52% 50% 50% / 35% 42% 55% 50%;
  transform: rotate(14deg);
  animation: seahorseTilt 10s ease-in-out infinite;
}
