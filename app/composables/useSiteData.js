export const useSiteData = () => {
  ...
  const techStack = [
    {
      ...
      items: [
        ...
        {
          name: 'Materialize',
          icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/materializecss/materializecss-original.svg'
        },
        {
          name: 'Angular',
  ...
  const socials = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/ragil-pratama-824351145/',
      icon: 'linkedin'
    },
